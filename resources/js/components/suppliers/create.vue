    ...
    <div class="row justify-content-center">
      <div class="col-xl-12 col-lg-12 col-md-12">
        <div>
          <div class="row">
            <div class="col-lg-3">
              <router-link to="/allSupplier" class="btn btn-primary btn-block">All Suppliers</router-link>
            </div>
          </div>
        </div>
                  ...
                  <form class="user" @submit.prevent="createSupplier" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                      <div class="form-row">
                        ...
                        <div class="col-lg-6">
                          <input type="text" class="form-control" id="shopname" placeholder="Enter Shop Name" v-model="form.shopname">
