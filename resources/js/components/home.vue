          ...
          <div class="card-body">
            <div class="row no-gutters align-items-center">
              <div class="col mr-2">
                ...
                <div class="h5 mb-0 font-weight-bold text-gray-800">RM {{ income }}</div>
                <div class="mt-2 mb-0 text-muted text-xs">
                  <span class="text-success mr-2"
          ...
          <div class="card-body">
            <div class="row no-gutters align-items-center">
              <div class="col mr-2">
                ...
                <div class="h5 mb-0 font-weight-bold text-gray-800">RM {{ expense }}</div>
                <div class="mt-2 mb-0 text-muted text-xs">
...
<script type="text/javascript">
  export default {
    ...
    methods: {
      TdySales(){
        axios.get('/api/pos/today/sales')
        .then(({data}) => (this.todaySales = data))
        .catch()
      },
      TdyIncomes(){
        axios.get('/api/pos/today/incomes')
        .then(({data}) => (this.income = data))
        .catch()
      },
      TdyDues(){
        axios.get('/api/pos/today/dues')
        .then(({data}) => (this.due = data))
        .catch()
      },
      TdyExpenses(){
        axios.get('/api/pos/today/expenses')
        .then(({data}) => (this.expense = data))
        .catch()
      },
      StockOut(){
        axios.get('/api/pos/today/stockout')
